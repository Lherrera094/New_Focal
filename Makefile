...
PROG_FILE_BASE_NAME = main cJSON initialize_grid advance_fields background_profiles boundary_module save_data grid_io auxiliar_module free_allocated_memory power_module antenna_module antenna_detector_module
