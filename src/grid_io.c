...
/*Read external file for background profiles*/
...
/*Function to save timetraces values*/
...
//{{{
    ...
    snprintf( filename, sizeof(filename), "%s/%s", fullDirectory, file_trace);
    ...
    if (file_pntr == NULL) {
        ...
        for ( ii=0 ; ii < (t_end/(int)period) ; ++ii ){
            fprintf( file_pntr, " %4d  %13.6e  %13.6e  %13.6e  %13.6e  %13.6e  %13.6e  %13.6e\n",
                    ...
                    ( timetraces(ii,2) + timetraces(ii,3) + timetraces(ii,4) + timetraces(ii,5) + 
                      timetraces(ii,6) + timetraces(ii,7) )
                  );
...
//    printf( "dataspace_id_i=%d\n", dataspace_id_i);
    ...
    for ( ii=2 ; ii<=N_x-2 ; ii+=2 ) {
        ...
        data2save[ii/2] = DET_ANT_ACCES(antDetect, id, ii/2, 0);
    }
    ...
    for ( ii=2 ; ii<=N_x-2 ; ii+=2 )
        ...
        data2save[ii/2] = DET_ANT_ACCES(antDetect, id, ii/2, 1);
    ...
    for ( ii=2 ; ii<=N_x-2 ; ii+=2 )
        ...
        data2save[ii/2] = DET_ANT_ACCES(antDetect, id, ii/2, 2);
    ...
    for ( ii=2 ; ii<=N_x-2 ; ii+=2 )
        ...
        data2save[ii/2] = DET_ANT_ACCES(antDetect, id, ii/2, 3);
    ...
    for ( ii=2 ; ii<=N_x-2 ; ii+=2 )
        ...
        data2save[ii/2] = DET_ANT_ACCES(antDetect, id, ii/2, 4);
